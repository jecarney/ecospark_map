$(document).ready(function() {
    ...
    function siteDataSuccessFnc(data, BAAorHBI) {
        ...
        for (i in rows) {
           ...
           var image = "bluedrop.png";

			var html = '<h4>' + SiteName + '</h4>Watershed: ' + Watershed + '<br/>Subwatershed: ' + Subwatershed + '<br/>Waterbody: ' + Waterbody + '<br/>Schools Sampled: ' + SchoolsSampled + '<br/><a target="_blank" href=' + DataLink + '>See Collected Data</a>';
    ...
    function mapLoaded() {
        ...
        google.maps.event.addListener(searchBox, 'places_changed', function() {
            var places = searchBox.getPlaces();
             console.log(places[0].geometry.location.k);
